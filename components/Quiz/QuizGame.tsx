...
const QuizGame = () => {
  ...
  }, [timer, started, setNextQuestion]);

  const handleAnswer = (option: string) => {
    setSelectedOption(option);
    if (categoryIndex !== null) {
      const correctAnswer = QuizData[categoryIndex].data[questionIndex].answer;
      if (option === correctAnswer) setScore((prevScore) => prevScore + 1);
    }
  };
      ...
      <Container maxWidth="md" sx={{ py: 4, alignContent: 'center' }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          >
            ...
            <Image src={'/brain.png'} height={300} width={300} alt="Quiz Game Icon" />
            <Button
              onClick={startGame}
              sx={{
      ...
      <Container maxWidth="md" sx={{ py: 4, alignContent: 'center' }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          >
            ...
            <Image alt="Game Over Icon" src={'/pngfind.com-clock-emoji-png-2467162.png'} height={100} width={100} />
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', alignItems: 'center', justifyContent: 'center', gap: 1 }}>
              ...
              >
                ...
                <Box sx={{ display: 'flex', justifyContent: 'center', mt: 4 }}>
                  {selectedOption && (
                    <Button variant="contained" sx={{ width: 'auto', px: 2, bgcolor: theme.palette.success.dark }} onClick={setNextQuestion}>
                      Next
                    </Button>
                  )}
                </Box>
